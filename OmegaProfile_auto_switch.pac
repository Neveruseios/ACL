var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)operacdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)freenom\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)abema\.tv$/.test(host)) return "+proxy";
        if (/^license\.theoplayer\.com$/.test(host)) return "+proxy";
        if (/^ani\.gamer\.com\.tw$/.test(host)) return "+proxy";
        if (/^gamer-cds\.cdn\.hinet\.net$/.test(host)) return "+proxy";
        if (/^www\.chromestatus\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)goo\./.test(host)) return "+proxy";
        if (/^licensing\.viblast\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)twimg\./.test(host)) return "+proxy";
        if (/(?:^|\.)yandex\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)cloudflare\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)greasyfork\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)google.*\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\./.test(host)) return "+proxy";
        if (/(?:^|\.)dmm\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bbc\.co\.uk$/.test(host)) return "+proxy";
        if (/(?:^|\.)youtube\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)github.*\./.test(host)) return "+proxy";
        if (/(?:^|\.)jp$/.test(host)) return "+proxy";
        if (/(?:^|\.)tk$/.test(host)) return "+proxy";
        if (/(?:^|\.)hk$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)openshiftapps\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ccleaner\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)000webhostapp\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)xda-developers\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)arukas\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)offcloud\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ipleak\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)maps\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)do-know\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)00v\.in$/.test(host)) return "+proxy";
        if (/(?:^|\.)pixiv\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)btstatic\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)viblast\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)geetest\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)speedtest\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)opengw\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)at2wn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)theoplayer\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)akamaized\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)googletagmanager\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)hayabusa\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)jisho\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)kotlincn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)gnome\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)dilidili\.wang$/.test(host)) return "DIRECT";
        if (/(?:^|\.)typcdn\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)saowen\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tuicool\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ytimg\.com$/.test(host)) return "+proxy";
        if (/.*ppa\.launchpad\.net.*/.test(host)) return "+proxy";
        if (/.*packages\.microsoft\.com.*/.test(host)) return "+proxy";
        if (/.*\.winehq\.org.*/.test(host)) return "+proxy";
